...
<p> I'm an experienced software engineer with a extensive understanding of the creative workflow, able to utilize technology efficiently in commercial settings.</p>

<p> Feel free to contact me here! </p>
{#if copied}
<div class="message">Email address copied to clipboard!</div>
{/if}
<div id="email" tabindex="0" role="button" on:keydown={handleKeyDown} class:highlighted={copied} on:click={copyEmail}>
